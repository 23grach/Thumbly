 ...
 * Тестируем настоящий код, а не моки!
 */
...
describe('🚀 Real Code Tests - ValidationUtils', () => {
  describe('validateThumbnailData', () => {
    ...
    test('should throw error for empty title', () => {
      const invalidData: ThumbnailData = {
        title: '',
        description: 'Valid Description',
        emoji: '🚀',
        theme: 'light',
    ...
    test('should throw error for invalid theme', () => {
      ...
      expect(() => {
        ValidationUtils.validateThumbnailData(invalidData as ThumbnailData);
...
describe('⚙️ Real Code Tests - Configuration Constants', () => {
  ...
  describe('FRAME_CONFIG', () => {
    test('should have valid dimensions', () => {
      ...
      const aspectRatio = LayoutUtils.validateAspectRatio(
        FRAME_CONFIG.width,
        FRAME_CONFIG.height
      );
    ...
    test('should have reasonable padding', () => {
      const contentArea = LayoutUtils.calculateContentArea(
        { width: FRAME_CONFIG.width, height: FRAME_CONFIG.height },
        FRAME_CONFIG.padding
      );
